...
| Не реализовано | Автоматическая выдача flair при выборе армии в игре. |
| Не реализовано | Blue Tribe flair. |
| Не реализовано | Динамические ранги, классы, медали и прогресс. |
